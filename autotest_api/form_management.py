...
from typing import Type, Generator, Dict, Union, List, Optional
...
def validate_against_schema(test_specs: Dict, schema: Dict, filenames: List[str]) -> Optional[str]:
    """
    Check if test_specs is valid according to the schema.
